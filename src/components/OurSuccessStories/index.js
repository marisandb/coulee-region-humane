    ...
    return (
        <section className='success'>
            ...
            <div className='flex-row'>
                ...
                <div >
                    <img className='success-img' src={flower1} alt="FLower the skunk as a baby" />
                    <img className='success-img' src={flower2} alt="Flower the skunk as a baby eating food." />
                    <img className='success-img' src={flower3} alt="Flower the skunk posing on a bench with some fall flowers next to her" />
                </div>
                <div>
                <p>
